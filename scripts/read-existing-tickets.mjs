...
let scanned = 0, matched = 0, ignored = 0, unreadable = 0, conflicts = 0, errors = 0;
try {
  ...
  console.log(`Ticket reader backfill: checked ${scanned}; Marietta numbers saved ${matched}; other/unrecognized ${ignored}; Marietta unreadable ${unreadable}; concurrent retries ${conflicts}; processing errors ${errors}.`);
